...
var ComputedField = ({ label, tooltip, value = "", suffix, className, visible }) => /* @__PURE__ */ jsx(FieldWrapper, { label, tooltip, className, visible, children: /* @__PURE__ */ jsxs("div", { className: "relative", children: [
  /* @__PURE__ */ jsx("div", { className: `border border-dashed border-edge-subtle/30 rounded-xl w-full text-sm px-3 py-2 ${suffixPadding(suffix)} tabular-nums bg-surface-0 text-ink-primary font-medium cursor-default select-none`, children: value }),
  ...
  return createPortal(
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-px p-1", children: items.map((item, i) => {
...
function SidebarFilter({ value, onChange, placeholder = "Filtrar..." }) {
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 bg-surface-2 border border-edge-subtle/30 rounded-btn px-3 h-9", children: [
    /* @__PURE__ */ jsx(icon_default, { name: "Search", size: 14, className: "text-ink-tertiary" }),
    /* @__PURE__ */ jsx(
      "input",
      {
        type: "text",
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative flex-1 min-w-0", children: [
      /* @__PURE__ */ jsx(
        "select",
        {
          ...
          children: options.map((opt) => /* @__PURE__ */ jsx("option", { value: opt.value, className: "bg-surface-2 text-ink-primary", children: opt.label }, opt.value))
        }
      ),
      /* @__PURE__ */ jsx(
        icon_default,
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
    /* @__PURE__ */ jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsx(icon_default, { name: "ChevronLeft", size: 16, className: "text-ink-secondary" })
      }
    ),
    ...
    /* @__PURE__ */ jsx(
      "button",
      {
        ...
        disabled: !hasNext,
        className: "h-8 w-8 flex items-center justify-center rounded-btn bg-surface-2 border border-edge-subtle/30 hover:bg-surface-3 disabled:opacity-30 disabled:cursor-not-allowed transition-colors",
        children: /* @__PURE__ */ jsx(icon_default, { name: "ChevronRight", size: 16, className: "text-ink-secondary" })
      }
    )
  ] });
}
  ...
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      className: `
            ...
            `,
      children: [
        /* @__PURE__ */ jsx(icon_default, { name: "ChevronLeft", size: 16 }),
        /* @__PURE__ */ jsx(icon_default, { name: icon, size: 16 }),
    ...
    /* @__PURE__ */ jsx("div", { className: "overflow-x-auto overflow-y-hidden mx-3 sm:mx-6 my-2.5 scrollbar-none", children: /* @__PURE__ */ jsx("div", { className: "flex w-fit gap-1.5", children: tabs.map((tab) => {
      ...
      return /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            tab.icon && /* @__PURE__ */ jsx(icon_default, { name: tab.icon, size: sizeConfig3.icon, className: `flex-shrink-0 ${dark ? isActive ? "text-brand-on" : "text-ink-tertiary" : isActive ? "text-theme-500" : "text-gray-400"}` }),
