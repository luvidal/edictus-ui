...
var Button = ({ icon, text, loading = false, variant = "primary", size = "md", className = "", ...props }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "button",
    {
      ...
      disabled: isDisabled,
      children: [
        loading ? /* @__PURE__ */ jsxRuntime.jsxs("svg", { className: `animate-spin h-4 w-4 text-current ${disabledContent}`, viewBox: "0 0 24 24", fill: "none", children: [
        ...
        ] }) : icon && /* @__PURE__ */ jsxRuntime.jsx(icon_default, { name: icon, size: 16, className: `shrink-0 ${disabledContent}` }),
        text && /* @__PURE__ */ jsxRuntime.jsx("span", { className: `truncate font-semibold ${disabledContent}`, children: text })
      ]
    }
  );
};
...
function FieldWrapper({ label, tooltip, className = "", visible = true, children }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `mb-2 ${className}`, children: [
    label && /* @__PURE__ */ jsxRuntime.jsx(label_default, { text: label, tooltip, className: "mb-1" }),
    children
  ] });
}
...
var suffixPadding = (suffix) => {
  if (!suffix) return "";
  if (suffix.length <= 1) return "!pr-6";
...
var Select = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(FieldWrapper, { label, tooltip, className, visible, children: /* @__PURE__ */ jsxRuntime.jsxs(
    "select",
    {
      value: value || "",
      disabled: readOnly,
...
var ComputedField = ({ label, tooltip, value = "", suffix, className, visible }) => /* @__PURE__ */ jsxRuntime.jsx(FieldWrapper, { label, tooltip, className, visible, children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative", children: [
  /* @__PURE__ */ jsxRuntime.jsx("div", { className: `border border-dashed border-edge-subtle/30 rounded-xl w-full text-sm px-3 py-2 ${suffixPadding(suffix)} tabular-nums bg-surface-0 text-ink-primary font-medium cursor-default select-none`, children: value }),
  suffix && /* @__PURE__ */ jsxRuntime.jsx("span", { "aria-hidden": "true", className: "absolute right-3 top-1/2 -translate-y-1/2 pl-1 text-xs leading-none text-ink-tertiary pointer-events-none select-none", children: suffix })
] }) });
...
var NumberField = ({
  ...
  className,
  visible
}) => /* @__PURE__ */ jsxRuntime.jsx(FieldWrapper, { label, tooltip, className, visible, children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative", children: [
  /* @__PURE__ */ jsxRuntime.jsx(
    "input",
    {
      type: "number",
      ...
      className: `${inputBase} ${suffixPadding(suffix)} tabular-nums [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none ${readOnly ? inputReadOnly : inputEditable}`
    }
  ),
  suffix && /* @__PURE__ */ jsxRuntime.jsx("span", { "aria-hidden": "true", className: "absolute right-3 top-1/2 -translate-y-1/2 pl-1 text-xs leading-none text-ink-tertiary pointer-events-none select-none", children: suffix })
] }) });
...
var TextField = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(FieldWrapper, { label, tooltip, className: wrapperClass, visible, children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative", children: [
    ...
    hasSuffix && /* @__PURE__ */ jsxRuntime.jsx("span", { "aria-hidden": "true", className: "absolute right-3 top-1/2 -translate-y-1/2 pl-1 text-xs leading-none text-ink-tertiary pointer-events-none select-none", children: suffix }),
...
var SelectField = ({
  ...
  className,
  visible
}) => /* @__PURE__ */ jsxRuntime.jsx(FieldWrapper, { label, tooltip, className, visible, children: /* @__PURE__ */ jsxRuntime.jsxs(
  "select",
  {
    value: value ?? "",
    disabled: readOnly,
...
var LogoUpload = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(FieldWrapper, { label, className, visible, children: [
    ...
    error && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-status-danger text-sm mt-2", children: error })
  ] });
};
...
var EmptyState = ({ title = "Sin elementos", description, className = "", variant = "light", icon, action }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `flex flex-col items-center justify-center w-full h-full min-h-48 p-8 ${className}`, children: [
    renderIcon(),
    /* @__PURE__ */ jsxRuntime.jsx("p", { className: `font-medium text-sm ${isDark ? "text-white/50" : "text-ink-secondary"}`, children: title }),
    description && /* @__PURE__ */ jsxRuntime.jsx("p", { className: `text-xs mt-1 text-center max-w-xs ${isDark ? "text-white/40" : "text-ink-tertiary"}`, children: description }),
...
var EditableTitle = ({ value, onChange, className = "" }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "h3",
    {
      ...
      children: [
        value,
        onChange && /* @__PURE__ */ jsxRuntime.jsx(icon_default, { name: "Pencil", size: 12, className: `opacity-0 group-hover/title:opacity-100 transition-opacity flex-shrink-0 ${hasCustomColor ? "text-current" : "text-ink-tertiary"}` })
      ]
    }
  );
};
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "span",
    {
      ...
      children: [
        ...
        onClick && /* @__PURE__ */ jsxRuntime.jsx(icon_default, { name: "Mail", size: 10, className: `hidden group-hover/name:inline ml-1 flex-shrink-0 ${hasCustomColor ? "text-current" : "text-ink-tertiary"}` })
      ]
    }
  );
};
...
var Accordion = ({ sections, forceExpanded = false, rememberOpen = true, storageKey, onChange }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "rounded-xl overflow-hidden border border-edge-subtle/20 bg-surface-1 shadow-token-sm flex-1 flex flex-col min-h-0", children: sections.map((section) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `border-b border-edge-subtle/10 last:border-b-0 flex flex-col ${isExpanded ? "flex-1 min-h-0" : ""}`, children: [
      /* @__PURE__ */ jsxRuntime.jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex-1 min-w-0 text-left flex items-baseline gap-1.5", children: [
              ...
              section.subtitle && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-[10px] text-ink-tertiary shrink-0", children: section.subtitle })
            ] }),
...
var PillTag = ({ children, grip }) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "inline-flex items-center gap-1.5 px-2.5 py-1 text-xs rounded-full bg-surface-2 border border-edge-subtle/15 text-ink-secondary", children: [
  grip && /* @__PURE__ */ jsxRuntime.jsx(icon_default, { name: "GripVertical", size: 12, className: "text-ink-tertiary" }),
...
function StatusLabel({ item, requestLabel, role, labels }) {
  ...
  if (item.status === "error") return /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-xs text-status-danger", children: item.error || "Error" });
